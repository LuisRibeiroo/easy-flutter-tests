...
const executeTestsCommandId = "easy-tests.executeTestsInTestFile"; //TODO: Globale Variable an 2 Stellen
const gotoTestsCommandId = "easy-tests.goToTestFile"; //TODO: Globale Variable an 2 Stellen
